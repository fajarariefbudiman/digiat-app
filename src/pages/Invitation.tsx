            ...
            <div className="relative z-10 px-12 text-center w-full flex flex-col items-center justify-between h-full py-10">
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="animate-slideDown">
                  <h1 className="text-2xl font-amoresa force-dark-text tracking-wider drop-shadow-lg">R & N</h1>
                </div>
            ...
            <div className="relative w-full max-w-[430px] min-h-screen mx-auto ">
                ...
                <div className="max-w-6xl mx-auto">
                  ...
                  <div className="grid grid-cols-1 gap-3 max-w-5xl mx-auto">
                    ...
                    <div className={`text-center bg-white bg-opacity-50 py-10 rounded-lg ${isOpened && page3Visible ? "animate-scaleUp" : "scroll-animate"}`}>
                      ...
                      <p className="text-[10px] font-serif text-gray-700 mb-6 leading-relaxed">Putra Pertama Bpk Hambali, S.Pd & Ibu Nur Asiyah, S.Pd.</p>
                    ...
                    <div className={`text-center bg-white bg-opacity-50 py-10 rounded-lg ${isOpened && page3Visible ? "animate-scaleUp" : "scroll-animate"}`}>
                      ...
                      <p className="text-[10px] font-serif text-gray-700 mb-6 leading-relaxed">Putri Bungsu Bpk. A. Suja'ih Ardiansyah & Ibu Arsiah</p>
                      <div className="bg-black bg-opacity-5 rounded-md w-fit px-2 py-1 mx-auto">
                        <a
              ...
              >
                ...
                <div className="text-center w-full">
                  ...
                  <p className={`font-semibold text-gray-600 text-center ${page9Visible ? "animate-slideDown" : ""}`}>Hambali, S.Pd. & Nur Asiyah, S.Pd.</p>
                  <p className={`font-semibold text-gray-600 text-center ${page9Visible ? "animate-slideDown" : ""}`}>Riki Nurhamzah, S.H. & Suratun Nufus, S.M.</p>
                </div>
                {/* Divider image */}
