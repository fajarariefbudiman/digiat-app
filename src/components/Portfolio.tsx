...
const websiteSampleProjects = [
  {
    ...
    image: "https://images.unsplash.com/photo-1505685296765-3a2736de412f?w=600&q=80",
    url: "https://motoshop-five.vercel.app/",
  },
  {
    id: 2,
    name: "Vutsal Store Template",
    description: "Landing page concept for a sports gear store with clean, dark modern aesthetics.",
